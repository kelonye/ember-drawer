...
module.exports = Em.Mixin.create({
  ...
  _showTopDrawer: function(e){
    var that = this;
    this.set('_showingTopDrawer', true);
  ...
  _showBottomDrawer: function(e){
    var that = this;
    this.set('_showingBottomDrawer', true);
  ...
  _showRightDrawer: function(e){
    var that = this;
    this.set('_showingRightDrawer', true);
  ...
  _hideTopDrawer: function(e){
    var that = this;
    this.set('_showingTopDrawer', false);
    Em.$('.component-drawer-top').css({
  ...
  _hideBottomDrawer: function(e){
    var that = this;
    this.set('_showingBottomDrawer', false);
    Em.$('.component-drawer-bottom').css({
  ...
  _hideRightDrawer: function(e){
    var that = this;
    this.set('_showingRightDrawer', false);
    Em.$('.component-drawer-right').css({
